...
module.exports.displayAddPage = (req, res, next) => {
    res.render('update/add',{title:'Add Contact',displayName:req.user?req.user.displayName:''})
}
...
module.exports.displayEditPage = (req, res, next) => {
    ...
    Contact.findById(id, (err, contactToEdit) => {
        if (err) {
            ...
            res.render('update/edit', { title: 'Edit Contact', contact: contactToEdit,displayName:req.user?req.user.displayName:'' });
        }
    });
}
